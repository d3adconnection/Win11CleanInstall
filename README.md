...
How to use:
 ...
 3. Install Windows 11 as normal

To disable automatically setting Dark theme on login, delete the "Roaming" folder under "sources\$OEM$\$1\Users\Default\AppData". Do not delete "Local"!
